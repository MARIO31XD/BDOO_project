...
public class CartaDAO {
    ...
    // READ
    //obtenir per id,
    // T es una variable que guarda una clase
    // i puede ser Carta o una subclase suya
    // devuelve algo de tipo T: si es encanteri, devuelve encanteri, etc.
    //                                                   al llamar la funcion se pone Nombreclase.class
    public <T extends Carta> T obtenirCartaPerID(int id, Class<T> tipus) {
